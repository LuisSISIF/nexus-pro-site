...
import { ArrowRight, Eye, EyeOff, Loader2, AlertCircle, FileText, Check, X, Star, Store, Briefcase, Building } from 'lucide-react';
                   ...
                   <Form {...form}>
                    <form onSubmit={form.handleSubmit(onFormSubmit)} className="space-y-8">
                        ...
                        <Button type="submit" className="w-full text-lg py-6 mt-8" disabled={loading}>
                            ...
                            {loading ? 'Finalizando Cadastro...' : 'Criar Conta e Ativar Plano'}
                        </Button>
                    </form>
                   </Form>
