...
import { CheckCircle2, Download, LogIn, MessageSquare, Rocket, PlayCircle } from 'lucide-react';
import AnimatedSection from '@/components/home/AnimatedSection';

const OnboardingStep = ({ icon: Icon, title, description, buttonText, buttonHref }: any) => (
  <div className="flex gap-6 p-6 rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-800/50 shadow-sm hover:shadow-md transition-shadow">
