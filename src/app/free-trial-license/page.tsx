      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-gray-800 dark:text-gray-200">
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            ...
            <ul className="list-disc pl-5 space-y-1 text-gray-700 dark:text-gray-300">
                <li>4.1. Até 2 usuários simultâneos.</li>
                <li>4.2. Controle de apenas 1 loja.</li>
                <li>4.3. 14 dias a contar do cadastro.</li>
                <li>4.4. Impressão de cupom não fiscal indisponível (CNPJ cliente não coletado).</li>
                <li>4.5. Demonstração de crediário limitada a 1 cliente.</li>
                <li>4.6. Suporte via e-mail (retorno em 24–48 h; seg–sex 9h–17h, sáb 9h–12h).</li>
            </ul>
            
            <SectionTitle>5. COLETA E TRATAMENTO DE DADOS</SectionTitle>
            <ul className="list-disc pl-5 space-y-1 text-gray-700 dark:text-gray-300">
                <li>5.1. <strong>Dados coletados:</strong> nome, CPF, e-mail, telefone, sexo, login e senha de administrador; nome, atividade principal e endereço da empresa.</li>
                <li>5.2. <strong>Finalidade:</strong> operacional para uso básico, cadastro de produtos, vendas, estoque, financeiro, funcionários e relatórios; sincronização e backup remoto para bancos online.</li>
                <li>5.3. <strong>Base legal:</strong> Execução de contrato (LGPD art. 7º, V) e Cumprimento de obrigação legal (emissão de NF-e).</li>
                <li>5.4. <strong>Retenção:</strong> 30 dias pós-teste para migração, depois exclusão.</li>
                <li>5.5. <strong>Localização dos servidores:</strong> América do Sul (São Paulo – SP).</li>
                <li>5.6. <strong>Segurança:</strong> criptografia de senhas; controle de acesso e permissões; credenciais no banco de dados.</li>
                <li>5.7. <strong>Exercício de direitos:</strong> solicitação via e-mail/suporte para acesso, correção ou exclusão.</li>
            </ul>
            ...
            <ul className="list-disc pl-5 space-y-1 text-gray-700 dark:text-gray-300">
                <li>7.1. <strong>Canais:</strong> e-mail, WhatsApp/chat, telefone (seg–sex 8h–18h, exceto feriados).</li>
                <li>7.2. <strong>Tempo de resposta:</strong> e-mail até 48 h úteis; chat/WhatsApp até 2 h úteis (planos pagos); telefone imediato (planos pagos).</li>
                <li>7.3. <strong>Limitações no teste:</strong> dúvidas de instalação/configuração inicial apenas.</li>
                <li>7.4. <strong>Documentação:</strong> guia rápido, PDFs e vídeos.</li>
            </ul>
            ...
            <SectionTitle>8. TRANSIÇÃO PARA PLANO PAGO E POLÍTICA DE COBRANÇA PROPORCIONAL</SectionTitle>
             <SubClause>
                ...
                <ClauseText className='mt-2'>8.5. Os planos pagos do NexusPro são oferecidos sob a modalidade pré-paga: o usuário realiza o pagamento antecipadamente para liberar o acesso ao sistema. Ao finalizar o período de teste, o usuário pode escolher a data de vencimento de sua mensalidade.</ClauseText>
                ...
                <ClauseText className='mt-2'>8.7. <strong>Fórmula de cálculo do valor proporcional:</strong></ClauseText>
                ...
                <ClauseText className='mt-2'>8.9. No momento da transição pode haver dois valores em aberto:</ClauseText>
                <ul className="list-disc pl-5 space-y-1">
                ...
                <ClauseText className='mt-2'>8.10. O acesso ao sistema é liberado mediante pagamento dos valores proporcionais e, posteriormente, o ciclo mensal será sempre iniciado e cobrado conforme a data de vencimento fixada pelo usuário.</ClauseText>
            </SubClause>

            <SectionTitle>9. DISPONIBILIDADE E MANUTENÇÃO</SectionTitle>
            <ul className="list-disc pl-5 space-y-1 text-gray-700 dark:text-gray-300">
                <li>9.1. <strong>Uptime banco online:</strong> ≥ 98%, salvo manutenções ou eventos de provedor.</li>
                <li>9.2. <strong>Manutenções programadas:</strong> aviso prévio de 24 h, geralmente 22h–5h.</li>
                <li>9.3. <strong>Backup diário:</strong> restauração a partir do backup mais recente.</li>
            </ul>
            
            <SectionTitle>10. COMUNICAÇÕES</SectionTitle>
            <ul className="list-disc pl-5 space-y-1 text-gray-700 dark:text-gray-300">
                <li>10.1. <strong>E-mail oficial:</strong> cadastrado pelo cliente no início do teste.</li>
                <li>10.2. <strong>Aviso de término:</strong> e-mail e mensagem no sistema com ≥ 3 dias de antecedência.</li>
                <li>10.3. <strong>Alterações nos termos:</strong> aviso com ≥ 15 dias.</li>
                <li>10.4. <strong>Suporte técnico:</strong> e-mail ou telefone conforme horários acima.</li>
            </ul>
