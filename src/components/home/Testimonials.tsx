      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div 
              key={index}
              className="bg-white dark:bg-gray-700 rounded-xl p-6 shadow-lg hover:shadow-2xl transition-shadow duration-300"
            >
              ...
              <div className="relative">
                <Quote className="w-8 h-8 text-blue-200 dark:text-blue-600 absolute -top-2 -left-2" />
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6 pl-6">
                  {testimonial.text}
                </p>
              </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white dark:bg-gray-700 rounded-lg p-6 text-center shadow-sm">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">Atendimento via WhatsApp e e-mail</p>
          </div>
